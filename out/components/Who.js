...
const Who = (props) => {
    ...
    const description = (React.createElement(Div, { className: "banner-content", sx: {
        ...
        React.createElement("p", { className: "second", style: { fontSize: rs.md ? 25 : 20, padding: rs.md ? 0 : 15, textAlign: rs.md ? "center" : "center" } },
            ...
            React.createElement(Span, { sx: { color: "#b749bf", fontWeight: "bolder" } }, price),
    ...
    const area1 = React.createElement(lib_1.Col, { md: 12, xs: 24 },
        React.createElement(lib_1.Flex, { justify: rs.md ? "center" : "center", style: { marginBottom: rs.md ? 0 : 20 } }, picture));
    const area2 = React.createElement(lib_1.Col, { md: 12, xs: 24 },
        React.createElement(lib_1.Flex, { justify: "center" }, description));
