...
const LifeCycleItem = (props) => {
    ...
    const md = React.createElement(React.Fragment, null,
        React.createElement(lib_1.Col, { xs: 24, md: (_a = props.md) !== null && _a !== void 0 ? _a : 8, style: { marginBottom: 35, marginTop: 35 } },
            React.createElement(lib_1.Row, { align: "stretch", justify: "center" },
                React.createElement(lib_1.Col, { xs: 24, style: { display: "flex" } },
                    React.createElement(lib_1.Flex, { justify: "center", align: "center", style: { width: "100%" } },
    ...
    const xs = (props.isLeftPic
        ? React.createElement(lib_1.Col, { xs: 24, md: 8 },
            React.createElement(lib_1.Row, { align: "stretch", justify: "center" },
                React.createElement(lib_1.Col, { xs: 4, style: { display: "flex" } },
                    React.createElement(lib_1.Flex, { justify: "center", align: "center", style: { width: "100%" } },
                ...
                React.createElement(lib_1.Col, { xs: 20 },
        ...
        : React.createElement(lib_1.Col, { xs: 24, md: 8 },
            React.createElement(lib_1.Row, { align: "stretch", justify: "center" },
                ...
                React.createElement(lib_1.Col, { xs: 4, style: { display: "flex", justifyContent: "flex-end" } },
                    React.createElement(lib_1.Flex, { justify: "center", align: "center", style: { width: "100%" } },
